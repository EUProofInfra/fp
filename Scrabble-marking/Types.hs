-- This file is
--
--   - used by the presubmit script to determine what should be stripped out from
--     student Scrabble.hs files
--
--   - imported from the updated Scrabble.hs, as well as from TestHelpers.
--     Therefore, this file must be a valid Haskell file.
--
-- This file consists of two parts: a header and "fragments". A line
-- consisting of five dashes separates the header from the fragments, as well
-- as each fragment individually. The fragments are used by the presubmit
-- script to mangle Scrabble.hs. The header is ignored by the presubmit
-- script.
